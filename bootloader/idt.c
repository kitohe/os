...
void idt_init()
{
	...
	IDT[32].selector = 0x18; /* KERNEL_CODE_SEGMENT_OFFSET */
	IDT[32].zero = 0;
	...
	IDT[33].selector = 0x18; /* KERNEL_CODE_SEGMENT_OFFSET */
	IDT[33].zero = 0;
	...
	IDT[34].selector = 0x18; /* KERNEL_CODE_SEGMENT_OFFSET */
	IDT[34].zero = 0;
	...
	IDT[35].selector = 0x18; /* KERNEL_CODE_SEGMENT_OFFSET */
	IDT[35].zero = 0;
	...
	IDT[36].selector = 0x18; /* KERNEL_CODE_SEGMENT_OFFSET */
	IDT[36].zero = 0;
	...
	IDT[37].selector = 0x18; /* KERNEL_CODE_SEGMENT_OFFSET */
	IDT[37].zero = 0;
	...
	IDT[38].selector = 0x18; /* KERNEL_CODE_SEGMENT_OFFSET */
	IDT[38].zero = 0;
	...
	IDT[39].selector = 0x18; /* KERNEL_CODE_SEGMENT_OFFSET */
	IDT[39].zero = 0;
	...
	IDT[40].selector = 0x18; /* KERNEL_CODE_SEGMENT_OFFSET */
	IDT[40].zero = 0;
	...
	IDT[41].selector = 0x18; /* KERNEL_CODE_SEGMENT_OFFSET */
	IDT[41].zero = 0;
	...
	IDT[42].selector = 0x18; /* KERNEL_CODE_SEGMENT_OFFSET */
	IDT[42].zero = 0;
	...
	IDT[43].selector = 0x18; /* KERNEL_CODE_SEGMENT_OFFSET */
	IDT[43].zero = 0;
	...
	IDT[44].selector = 0x18; /* KERNEL_CODE_SEGMENT_OFFSET */
	IDT[44].zero = 0;
	...
	IDT[45].selector = 0x18; /* KERNEL_CODE_SEGMENT_OFFSET */
	IDT[45].zero = 0;
	...
	IDT[46].selector = 0x18; /* KERNEL_CODE_SEGMENT_OFFSET */
	IDT[46].zero = 0;
	...
	IDT[47].selector = 0x18; /* KERNEL_CODE_SEGMENT_OFFSET */
	IDT[47].zero = 0;
